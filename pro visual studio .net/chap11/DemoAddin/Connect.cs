namespace DemoAddin
{
	...
	[GuidAttribute("993B41B1-8CBA-48B4-8EBC-7C032562FDBF"), ProgId("DemoAddin.Connect")]
	public class Connect : Object, Extensibility.IDTExtensibility2, IDTCommandTarget
	{
		...
		public Connect()
		{
			Debug.WriteLine("DemoAddin: Connect() constructor called");
		}
		...
		{
			Debug.WriteLine("DemoAddin: OnAddInsUpdate() method called");
		}
		...
		{
			Debug.WriteLine("DemoAddin: OnStartupComplete() method called");
		}
		...
		{
			Debug.WriteLine("DemoAddin: OnBeginShutdown() method called");
		}
