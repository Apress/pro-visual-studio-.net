namespace Apress.ProVisualStudio.chap11.IconExplorerAddIn
{
	...
	[GuidAttribute("365F6C44-04A0-4B84-9655-3088F68ADEAC"), ProgId("IconExplorerAddIn.Connect")]
	public class Connect : Object, Extensibility.IDTExtensibility2, IDTCommandTarget
	{
		...
		public Connect()
		{
			iconNumber = 2;  // Start at 2 because one, zero, or negative do not work (throw exceptions or give blank menu)
		}
		...
		private int iconNumber;			// private member variable added so we can increment it between calls to Exec()
